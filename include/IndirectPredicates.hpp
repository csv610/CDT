...
inline int dotProductSign2D_interval(IntervalNumber px, IntervalNumber py, IntervalNumber rx, IntervalNumber ry, IntervalNumber qx, IntervalNumber qy)
{
   setFPUModeToRoundUP();
   const IntervalNumber lx(px - qx);
   const IntervalNumber ly(py - qy);
   const IntervalNumber gx(rx - qx);
   const IntervalNumber gy(ry - qy);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber d(dx + dy);
...
inline int dotProductSign3D_interval(IntervalNumber px, IntervalNumber py, IntervalNumber pz, IntervalNumber rx, IntervalNumber ry, IntervalNumber rz, IntervalNumber qx, IntervalNumber qy, IntervalNumber qz)
{
   setFPUModeToRoundUP();
   const IntervalNumber lx(px - qx);
   const IntervalNumber ly(py - qy);
   const IntervalNumber lz(pz - qz);
   const IntervalNumber gx(rx - qx);
   const IntervalNumber gy(ry - qy);
   const IntervalNumber gz(rz - qz);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber dz(lz * gz);
   const IntervalNumber d1(dx + dy);
   const IntervalNumber d(d1 + dz);
   setFPUModeToRoundNEAR();
...
inline int incircle_interval(IntervalNumber pax, IntervalNumber pay, IntervalNumber pbx, IntervalNumber pby, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pdx, IntervalNumber pdy)
{
   setFPUModeToRoundUP();
   const IntervalNumber adx(pax - pdx);
   const IntervalNumber ady(pay - pdy);
   const IntervalNumber bdx(pbx - pdx);
   const IntervalNumber bdy(pby - pdy);
   const IntervalNumber cdx(pcx - pdx);
   const IntervalNumber cdy(pcy - pdy);
   const IntervalNumber abdeta(adx * bdy);
   const IntervalNumber abdetb(bdx * ady);
   const IntervalNumber abdet(abdeta - abdetb);
   const IntervalNumber bcdeta(bdx * cdy);
   const IntervalNumber bcdetb(cdx * bdy);
   const IntervalNumber bcdet(bcdeta - bcdetb);
   const IntervalNumber cadeta(cdx * ady);
   const IntervalNumber cadetb(adx * cdy);
   const IntervalNumber cadet(cadeta - cadetb);
   const IntervalNumber alifta(adx * adx);
   const IntervalNumber aliftb(ady * ady);
   const IntervalNumber alift(alifta + aliftb);
   const IntervalNumber blifta(bdx * bdx);
   const IntervalNumber bliftb(bdy * bdy);
   const IntervalNumber blift(blifta + bliftb);
   const IntervalNumber clifta(cdx * cdx);
   const IntervalNumber cliftb(cdy * cdy);
   const IntervalNumber clift(clifta + cliftb);
   const IntervalNumber la(alift * bcdet);
   const IntervalNumber lb(blift * cadet);
   const IntervalNumber lc(clift * abdet);
   const IntervalNumber lab(la + lb);
   const IntervalNumber L(lab + lc);
   setFPUModeToRoundNEAR();
...
inline int InSphere_interval(IntervalNumber pax, IntervalNumber pay, IntervalNumber paz, IntervalNumber pbx, IntervalNumber pby, IntervalNumber pbz, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pcz, IntervalNumber pdx, IntervalNumber pdy, IntervalNumber pdz, IntervalNumber pex, IntervalNumber pey, IntervalNumber pez)
{
   setFPUModeToRoundUP();
   const IntervalNumber aex(pax - pex);
   const IntervalNumber aey(pay - pey);
   const IntervalNumber aez(paz - pez);
   const IntervalNumber bex(pbx - pex);
   const IntervalNumber bey(pby - pey);
   const IntervalNumber bez(pbz - pez);
   const IntervalNumber cex(pcx - pex);
   const IntervalNumber cey(pcy - pey);
   const IntervalNumber cez(pcz - pez);
   const IntervalNumber dex(pdx - pex);
   const IntervalNumber dey(pdy - pey);
   const IntervalNumber dez(pdz - pez);
   const IntervalNumber aexbey(aex * bey);
   const IntervalNumber bexaey(bex * aey);
   const IntervalNumber ab(aexbey - bexaey);
   const IntervalNumber bexcey(bex * cey);
   const IntervalNumber cexbey(cex * bey);
   const IntervalNumber bc(bexcey - cexbey);
   const IntervalNumber cexdey(cex * dey);
   const IntervalNumber dexcey(dex * cey);
   const IntervalNumber cd(cexdey - dexcey);
   const IntervalNumber dexaey(dex * aey);
   const IntervalNumber aexdey(aex * dey);
   const IntervalNumber da(dexaey - aexdey);
   const IntervalNumber aexcey(aex * cey);
   const IntervalNumber cexaey(cex * aey);
   const IntervalNumber ac(aexcey - cexaey);
   const IntervalNumber bexdey(bex * dey);
   const IntervalNumber dexbey(dex * bey);
   const IntervalNumber bd(bexdey - dexbey);
   const IntervalNumber abc1(aez * bc);
   const IntervalNumber abc2(bez * ac);
   const IntervalNumber abc3(cez * ab);
   const IntervalNumber abc4(abc1 + abc3);
   const IntervalNumber abc(abc4 - abc2);
   const IntervalNumber bcd1(bez * cd);
   const IntervalNumber bcd2(cez * bd);
   const IntervalNumber bcd3(dez * bc);
   const IntervalNumber bcd4(bcd1 + bcd3);
   const IntervalNumber bcd(bcd4 - bcd2);
   const IntervalNumber cda1(cez * da);
   const IntervalNumber cda2(dez * ac);
   const IntervalNumber cda3(aez * cd);
   const IntervalNumber cda4(cda1 + cda3);
   const IntervalNumber cda(cda4 + cda2);
   const IntervalNumber dab1(dez * ab);
   const IntervalNumber dab2(aez * bd);
   const IntervalNumber dab3(bez * da);
   const IntervalNumber dab4(dab1 + dab3);
   const IntervalNumber dab(dab4 + dab2);
   const IntervalNumber al1(aex * aex);
   const IntervalNumber al2(aey * aey);
   const IntervalNumber al3(aez * aez);
   const IntervalNumber al4(al1 + al2);
   const IntervalNumber alift(al4 + al3);
   const IntervalNumber bl1(bex * bex);
   const IntervalNumber bl2(bey * bey);
   const IntervalNumber bl3(bez * bez);
   const IntervalNumber bl4(bl1 + bl2);
   const IntervalNumber blift(bl4 + bl3);
   const IntervalNumber cl1(cex * cex);
   const IntervalNumber cl2(cey * cey);
   const IntervalNumber cl3(cez * cez);
   const IntervalNumber cl4(cl1 + cl2);
   const IntervalNumber clift(cl4 + cl3);
   const IntervalNumber dl1(dex * dex);
   const IntervalNumber dl2(dey * dey);
   const IntervalNumber dl3(dez * dez);
   const IntervalNumber dl4(dl1 + dl2);
   const IntervalNumber dlift(dl4 + dl3);
   const IntervalNumber ds1(dlift * abc);
   const IntervalNumber ds2(clift * dab);
   const IntervalNumber dl(ds2 - ds1);
   const IntervalNumber dr1(blift * cda);
   const IntervalNumber dr2(alift * bcd);
   const IntervalNumber dr(dr2 - dr1);
   const IntervalNumber det(dl + dr);
   setFPUModeToRoundNEAR();
...
inline int dotProductSign2D_EEI_interval(const GenericPoint& q, IntervalNumber px, IntervalNumber py, IntervalNumber rx, IntervalNumber ry)
{
   IntervalNumber lqx, lqy, dq;
   if (
   !q.getIntervalLambda(lqx, lqy, dq)
   ) return Filtered_Sign::UNCERTAIN;

   setFPUModeToRoundUP();
   const IntervalNumber pxq(px * dq);
   const IntervalNumber pyq(py * dq);
   const IntervalNumber rxq(rx * dq);
   const IntervalNumber ryq(ry * dq);
   const IntervalNumber lx(pxq - lqx);
   const IntervalNumber ly(pyq - lqy);
   const IntervalNumber gx(rxq - lqx);
   const IntervalNumber gy(ryq - lqy);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber d(dx + dy);
   setFPUModeToRoundNEAR();
...
inline int dotProductSign2D_IEE_interval(const GenericPoint& p, IntervalNumber rx, IntervalNumber ry, IntervalNumber qx, IntervalNumber qy)
{
   IntervalNumber lpx, lpy, dp;
   if (
   !p.getIntervalLambda(lpx, lpy, dp)
   ) return Filtered_Sign::UNCERTAIN;

   setFPUModeToRoundUP();
   const IntervalNumber qxd(qx * dp);
   const IntervalNumber qyd(qy * dp);
   const IntervalNumber lx(lpx - qxd);
   const IntervalNumber ly(lpy - qyd);
   const IntervalNumber gx(rx - qx);
   const IntervalNumber gy(ry - qy);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
...
inline int dotProductSign2D_IEI_interval(const GenericPoint& p, const GenericPoint& q, IntervalNumber rx, IntervalNumber ry)
{
   IntervalNumber lpx, lpy, dp, lqx, lqy, dq;
   if (
   !p.getIntervalLambda(lpx, lpy, dp)
   || !q.getIntervalLambda(lqx, lqy, dq)
   ) return Filtered_Sign::UNCERTAIN;
   ...
   setFPUModeToRoundUP();
   const IntervalNumber dqp(dq * dp);
   const IntervalNumber pxq(lpx * dqp);
   const IntervalNumber pyq(lpy * dqp);
   const IntervalNumber rxq(rx * dq);
   const IntervalNumber ryq(ry * dq);
   const IntervalNumber lqxd(lqx * dp);
   const IntervalNumber lqyd(lqy * dp);
   const IntervalNumber lx(pxq - lqxd);
   const IntervalNumber ly(pyq - lqyd);
   const IntervalNumber gx(rxq - lqx);
   const IntervalNumber gy(ryq - lqy);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
...
inline int dotProductSign2D_IIE_interval(const GenericPoint& p, const GenericPoint& r, IntervalNumber qx, IntervalNumber qy)
{
   IntervalNumber lpx, lpy, dp, lrx, lry, dr;
   if (
   !p.getIntervalLambda(lpx, lpy, dp)
   ...
   const IntervalNumber lx(lpx - qxd);
   const IntervalNumber ly(lpy - qyd);
   const IntervalNumber qxr(qx * dr);
   const IntervalNumber qyr(qy * dr);
   const IntervalNumber gx(lrx - qxr);
   const IntervalNumber gy(lry - qyr);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber d(dx + dy);
   setFPUModeToRoundNEAR();
...
{
   IntervalNumber lpx, lpy, dp, lrx, lry, dr, lqx, lqy, dq;
   if (
   !p.getIntervalLambda(lpx, lpy, dp)
   || !r.getIntervalLambda(lrx, lry, dr)
   || !q.getIntervalLambda(lqx, lqy, dq)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber qxd(lqx * dp);
   const IntervalNumber qyd(lqy * dp);
   const IntervalNumber lpxq(lpx * dq);
   const IntervalNumber lpyq(lpy * dq);
   const IntervalNumber lx(lpxq - qxd);
   const IntervalNumber ly(lpyq - qyd);
   const IntervalNumber qxr(lqx * dr);
   const IntervalNumber qyr(lqy * dr);
   const IntervalNumber lrxq(lrx * dq);
   const IntervalNumber lryq(lry * dq);
   const IntervalNumber gx(lrxq - qxr);
   const IntervalNumber gy(lryq - qyr);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber d(dx + dy);
   setFPUModeToRoundNEAR();
...
inline int dotProductSign3D_EEI_interval(const GenericPoint& q, IntervalNumber px, IntervalNumber py, IntervalNumber pz, IntervalNumber rx, IntervalNumber ry, IntervalNumber rz)
{
   IntervalNumber lqx, lqy, lqz, dq;
   if (
   ...
   const IntervalNumber pxq(px * dq);
   const IntervalNumber pyq(py * dq);
   const IntervalNumber pzq(pz * dq);
   const IntervalNumber rxq(rx * dq);
   const IntervalNumber ryq(ry * dq);
   const IntervalNumber rzq(rz * dq);
   const IntervalNumber lx(pxq - lqx);
   const IntervalNumber ly(pyq - lqy);
   const IntervalNumber lz(pzq - lqz);
   const IntervalNumber gx(rxq - lqx);
   const IntervalNumber gy(ryq - lqy);
   const IntervalNumber gz(rzq - lqz);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber dz(lz * gz);
   const IntervalNumber d1(dx + dy);
...
inline int dotProductSign3D_IEE_interval(const GenericPoint& p, IntervalNumber rx, IntervalNumber ry, IntervalNumber rz, IntervalNumber qx, IntervalNumber qy, IntervalNumber qz)
{
   IntervalNumber lpx, lpy, lpz, dp;
   if (
   ...
   const IntervalNumber qxd(qx * dp);
   const IntervalNumber qyd(qy * dp);
   const IntervalNumber qzd(qz * dp);
   const IntervalNumber lx(lpx - qxd);
   const IntervalNumber ly(lpy - qyd);
   const IntervalNumber lz(lpz - qzd);
   const IntervalNumber gx(rx - qx);
   const IntervalNumber gy(ry - qy);
   const IntervalNumber gz(rz - qz);
   const IntervalNumber dx(lx * gx);
...
inline int dotProductSign3D_IEI_interval(const GenericPoint& p, const GenericPoint& q, IntervalNumber rx, IntervalNumber ry, IntervalNumber rz)
{
   IntervalNumber lpx, lpy, lpz, dp, lqx, lqy, lqz, dq;
   if (
   !p.getIntervalLambda(lpx, lpy, lpz, dp)
   || !q.getIntervalLambda(lqx, lqy, lqz, dq)
   ) return Filtered_Sign::UNCERTAIN;
   ...
   const IntervalNumber pxq(lpx * dqp);
   const IntervalNumber pyq(lpy * dqp);
   const IntervalNumber pzq(lpz * dqp);
   const IntervalNumber rxq(rx * dq);
   const IntervalNumber ryq(ry * dq);
   const IntervalNumber rzq(rz * dq);
   const IntervalNumber lqxd(lqx * dp);
   const IntervalNumber lqyd(lqy * dp);
   const IntervalNumber lqzd(lqz * dp);
   const IntervalNumber lx(pxq - lqxd);
   const IntervalNumber ly(pyq - lqyd);
   const IntervalNumber lz(pzq - lqzd);
   const IntervalNumber gx(rxq - lqx);
   const IntervalNumber gy(ryq - lqy);
   const IntervalNumber gz(rzq - lqz);
   const IntervalNumber dx(lx * gx);
...
inline int dotProductSign3D_IIE_interval(const GenericPoint& p, const GenericPoint& r, IntervalNumber qx, IntervalNumber qy, IntervalNumber qz)
{
   IntervalNumber lpx, lpy, lpz, dp, lrx, lry, lrz, dr;
   if (
   !p.getIntervalLambda(lpx, lpy, lpz, dp)
   ...
   const IntervalNumber qxr(qx * dr);
   const IntervalNumber qyr(qy * dr);
   const IntervalNumber qzr(qz * dr);
   const IntervalNumber gx(lrx - qxr);
   const IntervalNumber gy(lry - qyr);
   const IntervalNumber gz(lrz - qzr);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber dz(lz * gz);
   const IntervalNumber d1(dx + dy);
...
{
   IntervalNumber lpx, lpy, lpz, dp, lrx, lry, lrz, dr, lqx, lqy, lqz, dq;
   if (
   !p.getIntervalLambda(lpx, lpy, lpz, dp)
   || !r.getIntervalLambda(lrx, lry, lrz, dr)
   || !q.getIntervalLambda(lqx, lqy, lqz, dq)
   ...
   const IntervalNumber qxd(lqx * dp);
   const IntervalNumber qyd(lqy * dp);
   const IntervalNumber qzd(lqz * dp);
   const IntervalNumber lpxq(lpx * dq);
   const IntervalNumber lpyq(lpy * dq);
   const IntervalNumber lpzq(lpz * dq);
   const IntervalNumber lx(lpxq - qxd);
   const IntervalNumber ly(lpyq - qyd);
   const IntervalNumber lz(lpzq - qzd);
   const IntervalNumber qxr(lqx * dr);
   const IntervalNumber qyr(lqy * dr);
   const IntervalNumber qzr(lqz * dr);
   const IntervalNumber lrxq(lrx * dq);
   const IntervalNumber lryq(lry * dq);
   const IntervalNumber lrzq(lrz * dq);
   const IntervalNumber gx(lrxq - qxr);
   const IntervalNumber gy(lryq - qyr);
   const IntervalNumber gz(lrzq - qzr);
   const IntervalNumber dx(lx * gx);
   const IntervalNumber dy(ly * gy);
   const IntervalNumber dz(lz * gz);
   const IntervalNumber d1(dx + dy);
...
inline int incirclexy_indirect_IEEE_interval(const GenericPoint& p1, IntervalNumber pbx, IntervalNumber pby, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pdx, IntervalNumber pdy)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ) return Filtered_Sign::UNCERTAIN;

   setFPUModeToRoundUP();
   const IntervalNumber pdxt(pdx * d1);
   const IntervalNumber pdyt(pdy * d1);
   const IntervalNumber adx(l1x - pdxt);
   const IntervalNumber ady(l1y - pdyt);
   const IntervalNumber bdx(pbx - pdx);
   const IntervalNumber bdy(pby - pdy);
   const IntervalNumber cdx(pcx - pdx);
   const IntervalNumber cdy(pcy - pdy);
   ...
   const IntervalNumber clift(clifta + cliftb);
   const IntervalNumber la(alift * bcdet);
   const IntervalNumber lbt(blift * cadet);
   const IntervalNumber lb(lbt * d1);
   const IntervalNumber lct(clift * abdet);
   const IntervalNumber lc(lct * d1);
   const IntervalNumber lab(la + lb);
   const IntervalNumber L(lab + lc);
   setFPUModeToRoundNEAR();
...
inline int incirclexy_indirect_IIEE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pdx, IntervalNumber pdy)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber pdx1(pdx * d1);
   const IntervalNumber pdy1(pdy * d1);
   const IntervalNumber adx(l1x - pdx1);
   const IntervalNumber ady(l1y - pdy1);
   const IntervalNumber pdx2(pdx * d2);
   const IntervalNumber pdy2(pdy * d2);
   const IntervalNumber bdx(l2x - pdx2);
   const IntervalNumber bdy(l2y - pdy2);
   const IntervalNumber cdx(pcx - pdx);
   const IntervalNumber cdy(pcy - pdy);
   const IntervalNumber abdeta(adx * bdy);
   const IntervalNumber abdetb(bdx * ady);
   ...
   const IntervalNumber alifta(adx * adx);
   const IntervalNumber aliftb(ady * ady);
   const IntervalNumber aliftt(alifta + aliftb);
   const IntervalNumber alift(aliftt * d2);
   const IntervalNumber blifta(bdx * bdx);
   const IntervalNumber bliftb(bdy * bdy);
   const IntervalNumber blift(blifta + bliftb);
   const IntervalNumber clifta(cdx * cdx);
   const IntervalNumber cliftb(cdy * cdy);
   const IntervalNumber cliftt(clifta + cliftb);
   const IntervalNumber clift(cliftt * d2);
   const IntervalNumber la(alift * bcdet);
   const IntervalNumber lb(blift * cadet);
   const IntervalNumber lc(clift * abdet);
   const IntervalNumber lab(lc + lb);
   const IntervalNumber lab2(lab * d1);
   const IntervalNumber L(lab2 + la);
   setFPUModeToRoundNEAR();
...
inline int incirclexy_indirect_IIIE_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3, IntervalNumber pdx, IntervalNumber pdy)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   || !p2.getIntervalLambda(l2x, l2y, l2z, d2)
   ...
   const IntervalNumber bdx(l2x - pdx2);
   const IntervalNumber bdy(l2y - pdy2);
   const IntervalNumber pdx3(pdx * d3);
   const IntervalNumber pdy3(pdy * d3);
   const IntervalNumber cdx(l3x - pdx3);
   const IntervalNumber cdy(l3y - pdy3);
   const IntervalNumber abdeta(adx * bdy);
   const IntervalNumber abdetb(bdx * ady);
   const IntervalNumber abdet(abdeta - abdetb);
   const IntervalNumber bcdeta(bdx * cdy);
   ...
   const IntervalNumber aliftb(ady * ady);
   const IntervalNumber aliftt(alifta + aliftb);
   const IntervalNumber alift2(aliftt * d2);
   const IntervalNumber alift(alift2 * d3);
   const IntervalNumber blifta(bdx * bdx);
   const IntervalNumber bliftb(bdy * bdy);
   const IntervalNumber bliftt(blifta + bliftb);
   const IntervalNumber blift(bliftt * d3);
   const IntervalNumber clifta(cdx * cdx);
   const IntervalNumber cliftb(cdy * cdy);
   const IntervalNumber cliftt(clifta + cliftb);
   const IntervalNumber clift(cliftt * d2);
   ...
   const IntervalNumber lb(blift * cadet);
   const IntervalNumber lc(clift * abdet);
   const IntervalNumber lab2(lc + lb);
   const IntervalNumber lab(lab2 * d1);
   const IntervalNumber L(lab + la);
   setFPUModeToRoundNEAR();
...
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x, l4y, l4z, d4;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   || !p2.getIntervalLambda(l2x, l2y, l2z, d2)
   || !p3.getIntervalLambda(l3x, l3y, l3z, d3)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber l1xt(l1x * d4);
   const IntervalNumber l1yt(l1y * d4);
   const IntervalNumber l2xt(l2x * d4);
   const IntervalNumber l2yt(l2y * d4);
   const IntervalNumber l3xt(l3x * d4);
   const IntervalNumber l3yt(l3y * d4);
   const IntervalNumber l4x1(l4x * d1);
   const IntervalNumber l4y1(l4y * d1);
   const IntervalNumber adx(l1xt - l4x1);
   const IntervalNumber ady(l1yt - l4y1);
   const IntervalNumber l4x2(l4x * d2);
   const IntervalNumber l4y2(l4y * d2);
   const IntervalNumber bdx(l2xt - l4x2);
   const IntervalNumber bdy(l2yt - l4y2);
   const IntervalNumber l4x3(l4x * d3);
   const IntervalNumber l4y3(l4y * d3);
   const IntervalNumber cdx(l3xt - l4x3);
   const IntervalNumber cdy(l3yt - l4y3);
   const IntervalNumber abdeta(adx * bdy);
   const IntervalNumber abdetb(bdx * ady);
   const IntervalNumber abdet(abdeta - abdetb);
   const IntervalNumber bcdeta(bdx * cdy);
...
inline int incircle_indirect_IEEE_interval(const GenericPoint& p1, IntervalNumber pbx, IntervalNumber pby, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pdx, IntervalNumber pdy)
{
   IntervalNumber l1x, l1y, d1;
   if (
...
inline int incircle_indirect_IIEE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pdx, IntervalNumber pdy)
{
   IntervalNumber l1x, l1y, d1, l2x, l2y, d2;
   if (
   !p1.getIntervalLambda(l1x, l1y, d1)
...
inline int incircle_indirect_IIIE_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3, IntervalNumber pdx, IntervalNumber pdy)
{
...
{
   IntervalNumber l1x, l1y, d1, l2x, l2y, d2, l3x, l3y, d3, l4x, l4y, d4;
   if (
   !p1.getIntervalLambda(l1x, l1y, d1)
   || !p2.getIntervalLambda(l2x, l2y, d2)
   || !p3.getIntervalLambda(l3x, l3y, d3)
...
inline int InSphere_IEEEE_interval(const GenericPoint& p1, IntervalNumber pbx, IntervalNumber pby, IntervalNumber pbz, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pcz, IntervalNumber pdx, IntervalNumber pdy, IntervalNumber pdz, IntervalNumber pex, IntervalNumber pey, IntervalNumber pez)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber pexd(pex * d1);
   const IntervalNumber peyd(pey * d1);
   const IntervalNumber pezd(pez * d1);
   const IntervalNumber aex(l1x - pexd);
   const IntervalNumber aey(l1y - peyd);
   const IntervalNumber aez(l1z - pezd);
   const IntervalNumber bex(pbx - pex);
   const IntervalNumber bey(pby - pey);
   const IntervalNumber bez(pbz - pez);
   const IntervalNumber cex(pcx - pex);
   ...
   const IntervalNumber ds1(dlift * abc);
   const IntervalNumber ds2(clift * dab);
   const IntervalNumber dlp(ds2 - ds1);
   const IntervalNumber dl(dlp * d1);
   const IntervalNumber dr1p(blift * cda);
   const IntervalNumber dr1(dr1p * d1);
   const IntervalNumber dr2(alift * bcd);
   const IntervalNumber dr(dr2 - dr1);
   const IntervalNumber det(dl + dr);
   setFPUModeToRoundNEAR();
...
inline int InSphere_IIEEE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber pcx, IntervalNumber pcy, IntervalNumber pcz, IntervalNumber pdx, IntervalNumber pdy, IntervalNumber pdz, IntervalNumber pex, IntervalNumber pey, IntervalNumber pez)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   const IntervalNumber aey(l1y - peyd);
   const IntervalNumber aez(l1z - pezd);
   const IntervalNumber pexd2(pex * d2);
   const IntervalNumber peyd2(pey * d2);
   const IntervalNumber pezd2(pez * d2);
   const IntervalNumber bex(l2x - pexd2);
   const IntervalNumber bey(l2y - peyd2);
   const IntervalNumber bez(l2z - pezd2);
   const IntervalNumber cex(pcx - pex);
   const IntervalNumber cey(pcy - pey);
   const IntervalNumber cez(pcz - pez);
   const IntervalNumber dex(pdx - pex);
   ...
   const IntervalNumber ds2(clift * dab);
   const IntervalNumber dl(ds2 - ds1);
   const IntervalNumber dll(dl * d1);
   const IntervalNumber dlll(dll * d2);
   const IntervalNumber dr1(blift * cda);
   const IntervalNumber dr12(dr1 * d1);
   const IntervalNumber dr2(alift * bcd);
   const IntervalNumber dr22(dr2 * d2);
   const IntervalNumber dr(dr22 - dr12);
   const IntervalNumber det(dlll + dr);
   setFPUModeToRoundNEAR();
...
inline int InSphere_IIIEE_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3, IntervalNumber pdx, IntervalNumber pdy, IntervalNumber pdz, IntervalNumber pex, IntervalNumber pey, IntervalNumber pez)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   const IntervalNumber bey(l2y - peyd2);
   const IntervalNumber bez(l2z - pezd2);
   const IntervalNumber pexd3(pex * d3);
   const IntervalNumber peyd3(pey * d3);
   const IntervalNumber pezd3(pez * d3);
   const IntervalNumber cex(l3x - pexd3);
   const IntervalNumber cey(l3y - peyd3);
   const IntervalNumber cez(l3z - pezd3);
   const IntervalNumber dex(pdx - pex);
   const IntervalNumber dey(pdy - pey);
   const IntervalNumber dez(pdz - pez);
   const IntervalNumber aexbey(aex * bey);
   ...
   const IntervalNumber dlift(dl4 + dl3);
   const IntervalNumber ds1(dlift * abc);
   const IntervalNumber ds1n(ds1 * d3);
   const IntervalNumber ds2(clift * dab);
   const IntervalNumber dl(ds2 - ds1n);
   const IntervalNumber dlm(dl * d1);
   const IntervalNumber dln(dlm * d2);
   const IntervalNumber dr1(blift * cda);
   const IntervalNumber dr1n(dr1 * d1);
   const IntervalNumber dr2(alift * bcd);
   const IntervalNumber dr2n(dr2 * d2);
   const IntervalNumber dr(dr2n - dr1n);
   const IntervalNumber drn(dr * d3);
   const IntervalNumber det(dln + drn);
   setFPUModeToRoundNEAR();
...
inline int InSphere_IIIIE_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3, const GenericPoint& p4, IntervalNumber pex, IntervalNumber pey, IntervalNumber pez)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x, l4y, l4z, d4;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   const IntervalNumber cey(l3y - peyd3);
   const IntervalNumber cez(l3z - pezd3);
   const IntervalNumber pexd4(pex * d4);
   const IntervalNumber peyd4(pey * d4);
   const IntervalNumber pezd4(pez * d4);
   const IntervalNumber dex(l4x - pexd4);
   const IntervalNumber dey(l4y - peyd4);
   const IntervalNumber dez(l4z - pezd4);
   const IntervalNumber aexbey(aex * bey);
   const IntervalNumber bexaey(bex * aey);
   const IntervalNumber ab(aexbey - bexaey);
   const IntervalNumber bexcey(bex * cey);
   ...
   const IntervalNumber dlift(dl4 + dl3);
   const IntervalNumber ds1(dlift * abc);
   const IntervalNumber ds12(ds1 * d3);
   const IntervalNumber ds2(clift * dab);
   const IntervalNumber ds22(ds2 * d4);
   const IntervalNumber dl(ds22 - ds12);
   const IntervalNumber dlx1(dl * d1);
   const IntervalNumber dlx2(dlx1 * d2);
   const IntervalNumber dr1(blift * cda);
   const IntervalNumber dr12(dr1 * d1);
   const IntervalNumber dr2(alift * bcd);
   const IntervalNumber dr22(dr2 * d2);
   const IntervalNumber dr(dr22 - dr12);
   const IntervalNumber drx1(dr * d3);
   const IntervalNumber drx2(drx1 * d4);
   const IntervalNumber det(dlx2 + drx2);
   setFPUModeToRoundNEAR();
...
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3, l4x, l4y, l4z, d4, l5x, l5y, l5z, d5;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   || !p2.getIntervalLambda(l2x, l2y, l2z, d2)
   || !p3.getIntervalLambda(l3x, l3y, l3z, d3)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber pexd(l5x * d1);
   const IntervalNumber peyd(l5y * d1);
   const IntervalNumber pezd(l5z * d1);
   const IntervalNumber ll1x(l1x * d5);
   const IntervalNumber ll1y(l1y * d5);
   const IntervalNumber ll1z(l1z * d5);
   const IntervalNumber aex(ll1x - pexd);
   const IntervalNumber aey(ll1y - peyd);
   const IntervalNumber aez(ll1z - pezd);
   const IntervalNumber pexd2(l5x * d2);
   const IntervalNumber peyd2(l5y * d2);
   const IntervalNumber pezd2(l5z * d2);
   const IntervalNumber ll2x(l2x * d5);
   const IntervalNumber ll2y(l2y * d5);
   const IntervalNumber ll2z(l2z * d5);
   const IntervalNumber bex(ll2x - pexd2);
   const IntervalNumber bey(ll2y - peyd2);
   const IntervalNumber bez(ll2z - pezd2);
   const IntervalNumber pexd3(l5x * d3);
   const IntervalNumber peyd3(l5y * d3);
   const IntervalNumber pezd3(l5z * d3);
   const IntervalNumber ll3x(l3x * d5);
   const IntervalNumber ll3y(l3y * d5);
   const IntervalNumber ll3z(l3z * d5);
   const IntervalNumber cex(ll3x - pexd3);
   const IntervalNumber cey(ll3y - peyd3);
   const IntervalNumber cez(ll3z - pezd3);
   const IntervalNumber pexd4(l5x * d4);
   const IntervalNumber peyd4(l5y * d4);
   const IntervalNumber pezd4(l5z * d4);
   const IntervalNumber ll4x(l4x * d5);
   const IntervalNumber ll4y(l4y * d5);
   const IntervalNumber ll4z(l4z * d5);
   const IntervalNumber dex(ll4x - pexd4);
   const IntervalNumber dey(ll4y - peyd4);
   const IntervalNumber dez(ll4z - pezd4);
   const IntervalNumber aexbey(aex * bey);
   const IntervalNumber bexaey(bex * aey);
   const IntervalNumber ab(aexbey - bexaey);
   const IntervalNumber bexcey(bex * cey);
   ...
   const IntervalNumber ds1n(ds1 * d3);
   const IntervalNumber ds2(clift * dab);
   const IntervalNumber ds2n(ds2 * d4);
   const IntervalNumber dl(ds2n - ds1n);
   const IntervalNumber dla(dl * d1);
   const IntervalNumber dlb(dla * d2);
   const IntervalNumber dr1(blift * cda);
   const IntervalNumber dr1n(dr1 * d1);
   const IntervalNumber dr2(alift * bcd);
   const IntervalNumber dr2n(dr2 * d2);
   const IntervalNumber dr(dr2n - dr1n);
   const IntervalNumber dra(dr * d3);
   const IntervalNumber drb(dra * d4);
   const IntervalNumber det(dlb + drb);
   setFPUModeToRoundNEAR();
...
inline bool lambda2d_SSI_interval(IntervalNumber ea1x, IntervalNumber ea1y, IntervalNumber ea2x, IntervalNumber ea2y, IntervalNumber eb1x, IntervalNumber eb1y, IntervalNumber eb2x, IntervalNumber eb2y, IntervalNumber& lambda_x, IntervalNumber& lambda_y, IntervalNumber& lambda_det)
{
   setFPUModeToRoundUP();
   const IntervalNumber t1a(ea1x * ea2y);
   const IntervalNumber t1b(ea2x * ea1y);
   const IntervalNumber t1(t1a - t1b);
   const IntervalNumber tx2(eb1x - eb2x);
   const IntervalNumber t3a(eb1x * eb2y);
   const IntervalNumber t3b(eb2x * eb1y);
   const IntervalNumber t3(t3a - t3b);
   const IntervalNumber tx4(ea1x - ea2x);
   const IntervalNumber ty2(eb1y - eb2y);
   const IntervalNumber ty4(ea1y - ea2y);
   const IntervalNumber lxa(t1 * tx2);
   const IntervalNumber lxb(t3 * tx4);
   lambda_x = lxa - lxb;
   const IntervalNumber lya(t1 * ty2);
   const IntervalNumber lyb(t3 * ty4);
   lambda_y = lya - lyb;
   const IntervalNumber deta(tx4 * ty2);
   const IntervalNumber detb(tx2 * ty4);
...
inline bool lambda3d_LNC_interval(IntervalNumber px, IntervalNumber py, IntervalNumber pz, IntervalNumber qx, IntervalNumber qy, IntervalNumber qz, IntervalNumber t, IntervalNumber& lambda_x, IntervalNumber& lambda_y, IntervalNumber& lambda_z, IntervalNumber& lambda_d)
{
   setFPUModeToRoundUP();
   const IntervalNumber vx(px - qx);
   const IntervalNumber vy(py - qy);
   const IntervalNumber vz(pz - qz);
   const IntervalNumber vxt(vx * t);
   const IntervalNumber vyt(vy * t);
   const IntervalNumber vzt(vz * t);
   lambda_x = px - vxt;
   lambda_y = py - vyt;
   lambda_z = pz - vzt;
   lambda_d = 1;
...
{
   setFPUModeToRoundUP();
   const IntervalNumber a11(px - qx);
   const IntervalNumber a12(py - qy);
   const IntervalNumber a13(pz - qz);
   const IntervalNumber a21(sx - rx);
   const IntervalNumber a22(sy - ry);
   const IntervalNumber a23(sz - rz);
   const IntervalNumber a31(tx - rx);
   const IntervalNumber a32(ty - ry);
   const IntervalNumber a33(tz - rz);
   const IntervalNumber tv1(a22 * a33);
   const IntervalNumber tv2(a23 * a32);
   const IntervalNumber a2233(tv1 - tv2);
   const IntervalNumber tv3(a21 * a33);
   const IntervalNumber tv4(a23 * a31);
   const IntervalNumber a2133(tv3 - tv4);
   const IntervalNumber tv5(a21 * a32);
   const IntervalNumber tv6(a22 * a31);
   const IntervalNumber a2132(tv5 - tv6);
   const IntervalNumber tv7(a11 * a2233);
   const IntervalNumber tv8(a12 * a2133);
   const IntervalNumber tv9(a13 * a2132);
   const IntervalNumber tt1(tv7 - tv8);
   const IntervalNumber ld(tt1 + tv9);
   const IntervalNumber px_rx(px - rx);
   const IntervalNumber py_ry(py - ry);
   const IntervalNumber pz_rz(pz - rz);
   const IntervalNumber tt2(py_ry * a2133);
   const IntervalNumber tt3(px_rx * a2233);
   const IntervalNumber tt4(pz_rz * a2132);
   const IntervalNumber tt5(tt3 + tt4);
   const IntervalNumber n(tt5 - tt2);
   const IntervalNumber ax(a11 * n);
   const IntervalNumber ay(a12 * n);
   const IntervalNumber az(a13 * n);
   const IntervalNumber dpx(ld * px);
   const IntervalNumber dpy(ld * py);
   const IntervalNumber dpz(ld * pz);
   lambda_x = dpx - ax;
   lambda_y = dpy - ay;
   lambda_z = dpz - az;
   lambda_d = tt1 + tv9;
...
{
   setFPUModeToRoundUP();
   const IntervalNumber v3x(ov3x - ov2x);
   const IntervalNumber v3y(ov3y - ov2y);
   const IntervalNumber v3z(ov3z - ov2z);
   const IntervalNumber v2x(ov2x - ov1x);
   const IntervalNumber v2y(ov2y - ov1y);
   const IntervalNumber v2z(ov2z - ov1z);
   const IntervalNumber w3x(ow3x - ow2x);
   const IntervalNumber w3y(ow3y - ow2y);
   const IntervalNumber w3z(ow3z - ow2z);
   const IntervalNumber w2x(ow2x - ow1x);
   const IntervalNumber w2y(ow2y - ow1y);
   const IntervalNumber w2z(ow2z - ow1z);
   const IntervalNumber u3x(ou3x - ou2x);
   const IntervalNumber u3y(ou3y - ou2y);
   const IntervalNumber u3z(ou3z - ou2z);
   const IntervalNumber u2x(ou2x - ou1x);
   const IntervalNumber u2y(ou2y - ou1y);
   const IntervalNumber u2z(ou2z - ou1z);
   const IntervalNumber nvx1(v2y * v3z);
   const IntervalNumber nvx2(v2z * v3y);
   const IntervalNumber nvx(nvx1 - nvx2);
   const IntervalNumber nvy1(v3x * v2z);
   const IntervalNumber nvy2(v3z * v2x);
   const IntervalNumber nvy(nvy1 - nvy2);
   const IntervalNumber nvz1(v2x * v3y);
   const IntervalNumber nvz2(v2y * v3x);
   const IntervalNumber nvz(nvz1 - nvz2);
   const IntervalNumber nwx1(w2y * w3z);
   const IntervalNumber nwx2(w2z * w3y);
   const IntervalNumber nwx(nwx1 - nwx2);
   const IntervalNumber nwy1(w3x * w2z);
   const IntervalNumber nwy2(w3z * w2x);
   const IntervalNumber nwy(nwy1 - nwy2);
   const IntervalNumber nwz1(w2x * w3y);
   const IntervalNumber nwz2(w2y * w3x);
   const IntervalNumber nwz(nwz1 - nwz2);
   const IntervalNumber nux1(u2y * u3z);
   const IntervalNumber nux2(u2z * u3y);
   const IntervalNumber nux(nux1 - nux2);
   const IntervalNumber nuy1(u3x * u2z);
   const IntervalNumber nuy2(u3z * u2x);
   const IntervalNumber nuy(nuy1 - nuy2);
   const IntervalNumber nuz1(u2x * u3y);
   const IntervalNumber nuz2(u2y * u3x);
   const IntervalNumber nuz(nuz1 - nuz2);
   const IntervalNumber nwyuz1(nwy * nuz);
   const IntervalNumber nwyuz2(nwz * nuy);
   const IntervalNumber nwyuz(nwyuz1 - nwyuz2);
   const IntervalNumber nwxuz1(nwx * nuz);
   const IntervalNumber nwxuz2(nwz * nux);
   const IntervalNumber nwxuz(nwxuz1 - nwxuz2);
   const IntervalNumber nwxuy1(nwx * nuy);
   const IntervalNumber nwxuy2(nwy * nux);
   const IntervalNumber nwxuy(nwxuy1 - nwxuy2);
   const IntervalNumber nvyuz1(nvy * nuz);
   const IntervalNumber nvyuz2(nvz * nuy);
   const IntervalNumber nvyuz(nvyuz1 - nvyuz2);
   const IntervalNumber nvxuz1(nvx * nuz);
   const IntervalNumber nvxuz2(nvz * nux);
   const IntervalNumber nvxuz(nvxuz1 - nvxuz2);
   const IntervalNumber nvxuy1(nvx * nuy);
   const IntervalNumber nvxuy2(nvy * nux);
   const IntervalNumber nvxuy(nvxuy1 - nvxuy2);
   const IntervalNumber nvywz1(nvy * nwz);
   const IntervalNumber nvywz2(nvz * nwy);
   const IntervalNumber nvywz(nvywz1 - nvywz2);
   const IntervalNumber nvxwz1(nvx * nwz);
   const IntervalNumber nvxwz2(nvz * nwx);
   const IntervalNumber nvxwz(nvxwz1 - nvxwz2);
   const IntervalNumber nvxwy1(nvx * nwy);
   const IntervalNumber nvxwy2(nvy * nwx);
   const IntervalNumber nvxwy(nvxwy1 - nvxwy2);
   const IntervalNumber p1a(nvx * ov1x);
   const IntervalNumber p1b(nvy * ov1y);
   const IntervalNumber p1c(nvz * ov1z);
   const IntervalNumber p1ab(p1a + p1b);
   const IntervalNumber p1(p1ab + p1c);
   const IntervalNumber p2a(nwx * ow1x);
   const IntervalNumber p2b(nwy * ow1y);
   const IntervalNumber p2c(nwz * ow1z);
   const IntervalNumber p2ab(p2a + p2b);
   const IntervalNumber p2(p2ab + p2c);
   const IntervalNumber p3a(nux * ou1x);
   const IntervalNumber p3b(nuy * ou1y);
   const IntervalNumber p3c(nuz * ou1z);
   const IntervalNumber p3ab(p3a + p3b);
   const IntervalNumber p3(p3ab + p3c);
   const IntervalNumber lxa(p1 * nwyuz);
   const IntervalNumber lxb(p3 * nvywz);
   const IntervalNumber lxc(p2 * nvyuz);
   const IntervalNumber lxab(lxa + lxb);
   lambda_x = lxab - lxc;
   const IntervalNumber lya(p2 * nvxuz);
   const IntervalNumber lyb(p3 * nvxwz);
   const IntervalNumber lyc(p1 * nwxuz);
   const IntervalNumber lybc(lyc + lyb);
   lambda_y = lya - lybc;
   const IntervalNumber lza(p3 * nvxwy);
   const IntervalNumber lzb(p1 * nwxuy);
   const IntervalNumber lzc(p2 * nvxuy);
   const IntervalNumber lzab(lza + lzb);
   lambda_z = lzab - lzc;
   const IntervalNumber da(nvx * nwyuz);
   const IntervalNumber db(nvz * nwxuy);
   const IntervalNumber dc(nvy * nwxuz);
   const IntervalNumber dab(da + db);
   lambda_d = dab - dc;
   setFPUModeToRoundNEAR();
...
inline int lessThanOnX_IE_interval(const GenericPoint& p1, IntervalNumber bx)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber dbx(bx * d1);
   const IntervalNumber kx(l1x - dbx);
   setFPUModeToRoundNEAR();
...
inline int lessThanOnX_II_interval(const GenericPoint& p1, const GenericPoint& p2)
{
   ...
   setFPUModeToRoundUP();
   const IntervalNumber k1(d2 * l1x);
   const IntervalNumber k2(d1 * l2x);
   const IntervalNumber kx(k1 - k2);
   setFPUModeToRoundNEAR();
...
inline int lessThanOnY_IE_interval(const GenericPoint& p1, IntervalNumber by)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber dby(by * d1);
   const IntervalNumber ky(l1y - dby);
   setFPUModeToRoundNEAR();
...
inline int lessThanOnY_II_interval(const GenericPoint& p1, const GenericPoint& p2)
{
   ...
   setFPUModeToRoundUP();
   const IntervalNumber k1(d2 * l1y);
   const IntervalNumber k2(d1 * l2y);
   const IntervalNumber ky(k1 - k2);
   setFPUModeToRoundNEAR();
...
inline int lessThanOnZ_IE_interval(const GenericPoint& p1, IntervalNumber bz)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber dbz(bz * d1);
   const IntervalNumber kz(l1z - dbz);
   setFPUModeToRoundNEAR();
...
inline int lessThanOnZ_II_interval(const GenericPoint& p1, const GenericPoint& p2)
{
   ...
   setFPUModeToRoundUP();
   const IntervalNumber k1(d2 * l1z);
   const IntervalNumber k2(d1 * l2z);
   const IntervalNumber kz(k1 - k2);
   setFPUModeToRoundNEAR();
...
inline int orient2dxy_indirect_IEE_interval(const GenericPoint& p1, IntervalNumber p2x, IntervalNumber p2y, IntervalNumber p3x, IntervalNumber p3y)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber t1x(p2y - p3y);
   const IntervalNumber t1y(p3x - p2x);
   const IntervalNumber e2(l1x * t1x);
   const IntervalNumber e3(l1y * t1y);
   const IntervalNumber e(e2 + e3);
   const IntervalNumber pr1(p2x * p3y);
   const IntervalNumber pr2(p2y * p3x);
   const IntervalNumber pr(pr1 - pr2);
   const IntervalNumber dpr(d1 * pr);
   const IntervalNumber det(dpr + e);
   setFPUModeToRoundNEAR();
...
inline int orient2dxy_indirect_IIE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber op3x, IntervalNumber op3y)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber a(d1 * l2x);
   const IntervalNumber b(d2 * l1x);
   const IntervalNumber c(d1 * op3y);
   const IntervalNumber e(d1 * l2y);
   const IntervalNumber f(d2 * l1y);
   const IntervalNumber g(d1 * op3x);
   const IntervalNumber ab(a - b);
   const IntervalNumber cd(c - l1y);
   const IntervalNumber ef(e - f);
   const IntervalNumber gh(g - l1x);
   const IntervalNumber abcd(ab * cd);
   const IntervalNumber efgh(ef * gh);
   const IntervalNumber L(abcd - efgh);
   setFPUModeToRoundNEAR();
...
inline int orient2dxy_indirect_III_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3)
{
   ...
   const IntervalNumber a(d1 * l2x);
   const IntervalNumber b(d2 * l1x);
   const IntervalNumber c(d1 * l3y);
   const IntervalNumber d(d3 * l1y);
   const IntervalNumber e(d1 * l2y);
   const IntervalNumber f(d2 * l1y);
   const IntervalNumber g(d1 * l3x);
   const IntervalNumber h(d3 * l1x);
   const IntervalNumber ab(a - b);
   const IntervalNumber cd(c - d);
   const IntervalNumber ef(e - f);
   const IntervalNumber gh(g - h);
   const IntervalNumber abcd(ab * cd);
   const IntervalNumber efgh(ef * gh);
   const IntervalNumber L(abcd - efgh);
   setFPUModeToRoundNEAR();
...
inline int orient2dyz_indirect_IEE_interval(const GenericPoint& p1, IntervalNumber p2x, IntervalNumber p2y, IntervalNumber p3x, IntervalNumber p3y)
{
   IntervalNumber l1z, l1x, l1y, d1;
   if (
...
inline int orient2dyz_indirect_IIE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber op3x, IntervalNumber op3y)
{
   IntervalNumber l1z, l1x, l1y, d1, l2z, l2x, l2y, d2;
   if (
   !p1.getIntervalLambda(l1z, l1x, l1y, d1)
...
{
   IntervalNumber l1z, l1x, l1y, d1, l2z, l2x, l2y, d2, l3z, l3x, l3y, d3;
   if (
   !p1.getIntervalLambda(l1z, l1x, l1y, d1)
   || !p2.getIntervalLambda(l2z, l2x, l2y, d2)
...
inline int orient2dzx_indirect_IEE_interval(const GenericPoint& p1, IntervalNumber p2x, IntervalNumber p2y, IntervalNumber p3x, IntervalNumber p3y)
{
   IntervalNumber l1y, l1z, l1x, d1;
   if (
...
inline int orient2dzx_indirect_IIE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber op3x, IntervalNumber op3y)
{
   IntervalNumber l1y, l1z, l1x, d1, l2y, l2z, l2x, d2;
   if (
   !p1.getIntervalLambda(l1y, l1z, l1x, d1)
...
{
   IntervalNumber l1y, l1z, l1x, d1, l2y, l2z, l2x, d2, l3y, l3z, l3x, d3;
   if (
   !p1.getIntervalLambda(l1y, l1z, l1x, d1)
   || !p2.getIntervalLambda(l2y, l2z, l2x, d2)
...
inline int orient2d_indirect_IEE_interval(const GenericPoint& p1, IntervalNumber p2x, IntervalNumber p2y, IntervalNumber p3x, IntervalNumber p3y)
{
   IntervalNumber l1x, l1y, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, d1)
...
inline int orient2d_indirect_IIE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber p3x, IntervalNumber p3y)
{
   IntervalNumber l1x, l1y, d1, l2x, l2y, d2;
   if (
   !p1.getIntervalLambda(l1x, l1y, d1)
   ...
   const IntervalNumber a(d1 * l2x);
   const IntervalNumber b(d2 * l1x);
   const IntervalNumber c(d1 * p3y);
   const IntervalNumber e(d1 * l2y);
   const IntervalNumber f(d2 * l1y);
   const IntervalNumber g(d1 * p3x);
   const IntervalNumber ab(a - b);
   const IntervalNumber cd(c - l1y);
   const IntervalNumber ef(e - f);
   const IntervalNumber gh(g - l1x);
...
inline int orient3d_indirect_IEEE_interval(const GenericPoint& p1, IntervalNumber ax, IntervalNumber ay, IntervalNumber az, IntervalNumber bx, IntervalNumber by, IntervalNumber bz, IntervalNumber cx, IntervalNumber cy, IntervalNumber cz)
{
   IntervalNumber l1x, l1y, l1z, d1;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber dcx(d1 * cx);
   const IntervalNumber dcy(d1 * cy);
   const IntervalNumber dcz(d1 * cz);
   const IntervalNumber ix_cx(l1x - dcx);
   const IntervalNumber iy_cy(l1y - dcy);
   const IntervalNumber ax_cx(ax - cx);
   const IntervalNumber ay_cy(ay - cy);
   const IntervalNumber az_cz(az - cz);
   const IntervalNumber iz_cz(l1z - dcz);
   const IntervalNumber bx_cx(bx - cx);
   const IntervalNumber by_cy(by - cy);
   const IntervalNumber bz_cz(bz - cz);
   const IntervalNumber tmc_a(ix_cx * ay_cy);
   const IntervalNumber tmc_b(iy_cy * ax_cx);
   const IntervalNumber m01(tmc_a - tmc_b);
   const IntervalNumber tmi_a(ix_cx * az_cz);
   const IntervalNumber tmi_b(iz_cz * ax_cx);
   const IntervalNumber m02(tmi_a - tmi_b);
   const IntervalNumber tma_a(iy_cy * az_cz);
   const IntervalNumber tma_b(iz_cz * ay_cy);
   const IntervalNumber m12(tma_a - tma_b);
   const IntervalNumber mt1(m01 * bz_cz);
   const IntervalNumber mt2(m02 * by_cy);
   const IntervalNumber mt3(m12 * bx_cx);
   const IntervalNumber mtt(mt2 - mt1);
   const IntervalNumber m012(mtt - mt3);
   setFPUModeToRoundNEAR();
...
inline int orient3d_indirect_IIEE_interval(const GenericPoint& p1, const GenericPoint& p2, IntervalNumber p3x, IntervalNumber p3y, IntervalNumber p3z, IntervalNumber p4x, IntervalNumber p4y, IntervalNumber p4z)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   setFPUModeToRoundUP();
   const IntervalNumber d1p4x(d1 * p4x);
   const IntervalNumber d1p4y(d1 * p4y);
   const IntervalNumber d1p4z(d1 * p4z);
   const IntervalNumber d2p4x(d2 * p4x);
   const IntervalNumber d2p4y(d2 * p4y);
   const IntervalNumber d2p4z(d2 * p4z);
   const IntervalNumber p1p4x(l1x - d1p4x);
   const IntervalNumber p1p4y(l1y - d1p4y);
   const IntervalNumber p1p4z(l1z - d1p4z);
   const IntervalNumber p2p4x(l2x - d2p4x);
   const IntervalNumber p2p4y(l2y - d2p4y);
   const IntervalNumber p2p4z(l2z - d2p4z);
   const IntervalNumber p3p4x(p3x - p4x);
   const IntervalNumber p3p4y(p3y - p4y);
   const IntervalNumber p3p4z(p3z - p4z);
   const IntervalNumber tmc_a(p1p4x * p2p4y);
   const IntervalNumber tmc_b(p1p4y * p2p4x);
   const IntervalNumber m01(tmc_a - tmc_b);
   const IntervalNumber tmi_a(p1p4x * p2p4z);
   const IntervalNumber tmi_b(p1p4z * p2p4x);
   const IntervalNumber m02(tmi_a - tmi_b);
   const IntervalNumber tma_a(p1p4y * p2p4z);
   const IntervalNumber tma_b(p1p4z * p2p4y);
   const IntervalNumber m12(tma_a - tma_b);
   const IntervalNumber mt1(m01 * p3p4z);
   const IntervalNumber mt2(m02 * p3p4y);
   const IntervalNumber mt3(m12 * p3p4x);
   const IntervalNumber mtt(mt2 - mt1);
   const IntervalNumber m012(mtt - mt3);
   setFPUModeToRoundNEAR();
...
inline int orient3d_indirect_IIIE_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3, IntervalNumber p4x, IntervalNumber p4y, IntervalNumber p4z)
{
   IntervalNumber l1x, l1y, l1z, d1, l2x, l2y, l2z, d2, l3x, l3y, l3z, d3;
   if (
   !p1.getIntervalLambda(l1x, l1y, l1z, d1)
   ...
   const IntervalNumber d2p4y(d2 * p4y);
   const IntervalNumber d2p4z(d2 * p4z);
   const IntervalNumber d3p4x(d3 * p4x);
   const IntervalNumber d3p4y(d3 * p4y);
   const IntervalNumber d3p4z(d3 * p4z);
   const IntervalNumber p1p4x(l1x - d1p4x);
   const IntervalNumber p1p4y(l1y - d1p4y);
   const IntervalNumber p1p4z(l1z - d1p4z);
   const IntervalNumber p2p4x(l2x - d2p4x);
   const IntervalNumber p2p4y(l2y - d2p4y);
   const IntervalNumber p2p4z(l2z - d2p4z);
   const IntervalNumber p3p4x(l3x - d3p4x);
   const IntervalNumber p3p4y(l3y - d3p4y);
   const IntervalNumber p3p4z(l3z - d3p4z);
   const IntervalNumber tmc_a(p1p4x * p2p4y);
   const IntervalNumber tmc_b(p1p4y * p2p4x);
   const IntervalNumber m01(tmc_a - tmc_b);
   const IntervalNumber tmi_a(p1p4x * p2p4z);
...
inline int orient3d_indirect_IIII_interval(const GenericPoint& p1, const GenericPoint& p2, const GenericPoint& p3, const GenericPoint& p4)
{
   ...
   setFPUModeToRoundUP();
   const IntervalNumber d1p4x(d1 * l4x);
   const IntervalNumber d1p4y(d1 * l4y);
   const IntervalNumber d1p4z(d1 * l4z);
   const IntervalNumber d2p4x(d2 * l4x);
   const IntervalNumber d2p4y(d2 * l4y);
   const IntervalNumber d2p4z(d2 * l4z);
   const IntervalNumber d3p4x(d3 * l4x);
   const IntervalNumber d3p4y(d3 * l4y);
   const IntervalNumber d3p4z(d3 * l4z);
   const IntervalNumber d4l1x(d4 * l1x);
   const IntervalNumber d4l1y(d4 * l1y);
   const IntervalNumber d4l1z(d4 * l1z);
   const IntervalNumber d4l2x(d4 * l2x);
   const IntervalNumber d4l2y(d4 * l2y);
   const IntervalNumber d4l2z(d4 * l2z);
   const IntervalNumber d4l3x(d4 * l3x);
   const IntervalNumber d4l3y(d4 * l3y);
   const IntervalNumber d4l3z(d4 * l3z);
   const IntervalNumber p1p4x(d4l1x - d1p4x);
   const IntervalNumber p1p4y(d4l1y - d1p4y);
   const IntervalNumber p1p4z(d4l1z - d1p4z);
   const IntervalNumber p2p4x(d4l2x - d2p4x);
   const IntervalNumber p2p4y(d4l2y - d2p4y);
   const IntervalNumber p2p4z(d4l2z - d2p4z);
   const IntervalNumber p3p4x(d4l3x - d3p4x);
   const IntervalNumber p3p4y(d4l3y - d3p4y);
   const IntervalNumber p3p4z(d4l3z - d3p4z);
   const IntervalNumber tmc_a(p1p4x * p2p4y);
   const IntervalNumber tmc_b(p1p4y * p2p4x);
   const IntervalNumber m01(tmc_a - tmc_b);
   const IntervalNumber tmi_a(p1p4x * p2p4z);
