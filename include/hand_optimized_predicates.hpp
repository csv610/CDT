...
inline int orient2d_interval(IntervalNumber p1x, IntervalNumber p1y, IntervalNumber p2x, IntervalNumber p2y, IntervalNumber p3x, IntervalNumber p3y)
{
   setFPUModeToRoundUP();
   IntervalNumber a11(p2x - p1x);
   IntervalNumber a12(p2y - p1y);
   IntervalNumber a21(p3x - p1x);
   IntervalNumber a22(p3y - p1y);
   IntervalNumber d1(a11 * a22);
   IntervalNumber d2(a12 * a21);
   IntervalNumber d(d1 - d2);
...
inline int orient3d_interval(IntervalNumber px, IntervalNumber py, IntervalNumber pz, IntervalNumber qx, IntervalNumber qy, IntervalNumber qz, IntervalNumber rx, IntervalNumber ry, IntervalNumber rz, IntervalNumber sx, IntervalNumber sy, IntervalNumber sz)
{
   setFPUModeToRoundUP();
   IntervalNumber qx_px(qx - px);
   IntervalNumber qy_py(qy - py);
   IntervalNumber rx_px(rx - px);
   IntervalNumber ry_py(ry - py);
   IntervalNumber rz_pz(rz - pz);
   IntervalNumber qz_pz(qz - pz);
   IntervalNumber sx_px(sx - px);
   IntervalNumber sy_py(sy - py);
   IntervalNumber sz_pz(sz - pz);
   IntervalNumber tmp_a(qx_px * ry_py);
   IntervalNumber tmp_b(qy_py * rx_px);
   IntervalNumber m01(tmp_a - tmp_b);
   IntervalNumber tmq_a(qx_px * rz_pz);
   IntervalNumber tmq_b(qz_pz * rx_px);
   IntervalNumber m02(tmq_a - tmq_b);
   IntervalNumber tmr_a(qy_py * rz_pz);
   IntervalNumber tmr_b(qz_pz * ry_py);
   IntervalNumber m12(tmr_a - tmr_b);
   IntervalNumber mt1(m01 * sz_pz);
   IntervalNumber mt2(m02 * sy_py);
   IntervalNumber mt3(m12 * sx_px);
   IntervalNumber mtt(mt1 - mt2);
